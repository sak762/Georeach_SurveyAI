...
$("#sb_location-month-tab").on("shown.bs.tab", function () {
  $(regionMapM).vectorMap({
    ...
    markerStyle: {
      initial: { fill: "#5F63F215", stroke: "#5F63F2", "stroke-width": 4 },
    },
    markers: [
...
!(function (e) {
      ...
      .on("resize", function () {
        ...
        e(this).width() <= 767.98
          ? (e(".navbar-right__menu").appendTo(".mobile-author-actions"),
            ...
            e(".sidebar ").removeClass("sidebar-collapse"),
  ...
  h && h.forEach((e) => e.addEventListener("click", C)),
  ...
  T &&
    ...
    x && x.forEach((e) => e.addEventListener("click", D)),
      ...
      btnsDef: {
        svgPath:
          "undefined" != typeof env && env.editorIconUrl
            ? env.editorIconUrl
            : "img/ui/icons.svg",
        image: { dropdown: ["insertImage", "base64"], ico: "insertImage" },
      },
      btns: [
        ["viewHTML"],
        ["formatting"],
    ...
    e.addEventListener("mouseover", function () {
      ...
      (a.style.top = t.top + "px"),
        "ltr" === q
          ...
          : "rtl" === q &&
            (a.style.right = Math.round(0.75 * e.offsetWidth) + 10 + "px");
    });
  });
  ...
  function H(t) {
    t.preventDefault(),
      "label" == this.dataset.trigger
        ...
        : "compose" == this.dataset.trigger && I.classList.add("show"),
      e(t.target).hasClass("label-close") && O.classList.remove("show");
  }
  function Q(e) {
    e.preventDefault(),
      "label" == this.dataset.trigger
        ? O.classList.remove("show")
        : "compose" == this.dataset.trigger && I.classList.remove("show");
  }
  null !== R &&
    null !== B &&
    (R.addEventListener("click", H), z.addEventListener("click", H)),
    null !== B &&
      null !== P &&
      (B.addEventListener("click", Q), P.addEventListener("click", Q));
  ...
  U &&
    (U.forEach((e) => e.addEventListener("click", j)),
    U.forEach((e) => e.addEventListener("click", J)));
  ...
  N &&
    ...
    G && X && (G.addEventListener("click", J), X.addEventListener("click", J)),
      ...
      e({ p: 0 })
        .animate(
          { p: s },
          {
            duration: 3e3,
            step: function (e) {
              t.css({ transform: "rotate(" + (45 + 1.8 * e) + "deg)" }),
                a.text(0 | e);
            },
          }
        )
